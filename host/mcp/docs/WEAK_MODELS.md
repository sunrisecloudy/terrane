# Terrane MCP Weak-Model Playbook

This guide is for small, cheap, or locked-down models with little or no prior
knowledge of Terrane.
...
A weak-model test should prove:
