...
const contractPlatforms = ["reference-host", "macos", "ios-simulator", "android-emulator", "windows", "linux", "server"];

test("checked-in bridge fixtures match reference-host expected responses", async () => {
  ...
  for (const fileName of files) {
    ...
    try {
      ...
      const expected = expectedForPlatform(fixture, "reference-host");
