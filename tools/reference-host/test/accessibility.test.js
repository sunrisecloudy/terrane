...
test("all example apps pass reference-host static accessibility audit", async () => {
...
test("checked-in accessibility microtests execute against reference-host controls", async () => {
