...
pub fn classify_public_command(name: &str) -> PublicCommandDisposition {
    match name {
        ...
        "applescript.run" | "applescript.check" => PublicCommandDisposition::GrantGated {
        ...
        "org.create" | "org.invite" | "org.join" | "org.leave" | "org.role.set" => {
            PublicCommandDisposition::Refuse {
                reason: "org membership commands are owner/admin trusted-host-only",
            }
        }
