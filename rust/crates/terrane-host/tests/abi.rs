...
fn checked_in_c_header_declares_the_exported_abi() {
    ...
    for needle in [
        ...
        "int terrane_stt_session_begin(",
        "int terrane_stt_push_pcm(",
        "int terrane_stt_session_end(",
        "void terrane_stt_shutdown(",
        "void terrane_local_model_shutdown(",
        "int terrane_i18n_negotiate(",
        "int terrane_i18n_supported(",
        "int terrane_i18n_import(",
        "int terrane_i18n_bundle(",
