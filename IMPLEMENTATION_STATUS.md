...
| Path | Status |
|---|---|
| `tests/fixtures/bridge/` | partial (31 fixtures are exercised by reference-host bridge tests and Zig server bridge contract tests: the expanded docs/08 required fixtures now cover every fixed bridge method, network policy edge cases, and focused core.step parity for `CreateTask`, `NetworkSnapshotReceived`, and unknown events) |
