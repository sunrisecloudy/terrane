...
| `tests/mutation/` | partial (25 mutations now exercised by fake-host validator/runtime tests, including direct network/storage APIs, service workers, sandbox escape APIs, inline-style CSP drift, invalid manifests, tampering, and runtime-denied paths) |
