...
| `tools/fake-platform-host/` | partial | Node fake host with SQLite migrations, control HTTP surface, package validation/install, Ed25519 signing, verified mount gate, bridge dispatch, and focused tests |
