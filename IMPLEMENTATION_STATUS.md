...
| `tests/performance/` | partial (fake-host harness reports p50/p95 for app open, app switch, storage, and core bridge round-trips, plus bridge-throughput, open-all-examples memory, large-list windowing, network-timeout, and install/uninstall lifecycle cleanup scenarios) |
