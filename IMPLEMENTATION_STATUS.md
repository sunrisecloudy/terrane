...
| `tests/mutation/` | partial (24 mutations now exercised by fake-host validator/runtime tests, including direct network/storage APIs, service workers, sandbox escape APIs, invalid manifests, tampering, and runtime-denied paths) |
