...
| `tests/mutation/` | partial (27 mutations now exercised by fake-host validator/runtime tests, including direct network/storage APIs, service workers, sandbox escape APIs, inline-style CSP drift, app script tag drift, invalid manifests, tampering, and runtime-denied paths) |
