...
- Runtime-load launch smoke runs with `NATIVE_AI_IOS_SMOKE_LAUNCH=1 node --test --no-warnings tools/fake-platform-host/test/ios-native-build.test.js` when CoreSimulator is available.
