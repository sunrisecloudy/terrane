...
Remaining persistence work: browser-backed smoke-test execution, installer-integrated migration chains, migration-linked data rollback, and the Postgres production adapter.
