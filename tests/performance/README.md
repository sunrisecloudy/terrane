...
Default runs use the spec methodology: 50 warm-up iterations, 500 measured samples, 50 install/uninstall lifecycle loops, and p50/p95 reporting. Use `--enforce-targets` in CI or release qualification when the host machine is quiet enough for timing assertions.
